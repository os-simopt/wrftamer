...
def initialize_wrf_namelist(namelist_vars: dict, namelistfile: str, templatefile=None):
    ...
    max_keylen = 0
    dom_keys = ('start_year start_month start_day start_hour start_date '
